...
— **Окружение и инструменты:** обязательно используй инструменты проекта: {required_tools_str}. Локальные черновики допускаются, но итоговые артефакты должны быть проверяемыми.
...
— **Окружение и инструменты:** обязательно используй инструменты проекта: {required_tools_str}. Локальная работа допускается для черновиков, итог должен воспроизводиться в целевом окружении.
...
— **Окружение и инструменты:** обязательно используй целевое окружение и инструменты: {required_tools_str}. Локальное окружение допускается для черновиков, итог должен воспроизводиться.
