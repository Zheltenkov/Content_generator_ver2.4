...
- Определения терминов (используй алфавит и определения из родного языка)
...
5. Определения терминов:
   - Используй алфавит целевого языка ({target_language})
...
class TranslatorAgent:
    ...
    def _make_context_header(last_heading: str, target_lang_name: str) -> str:
        ...
        return (
            ...
            f"заголовки и определения. Не оставляй текст на исходном языке.]"
        )
